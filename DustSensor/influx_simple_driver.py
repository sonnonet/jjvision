...
def main(val, host='localhost', port='8086', measurename = default_mname):
...
def influx_write(val, host='127.0.0.1',  port=8086) :
    print "trying to ..."
    print val, host, port 
    ...
    try:
        ...
        print "    [influx connect], something wrong ", __file__
        pass
